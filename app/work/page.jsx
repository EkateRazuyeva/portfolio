...
const projects = [
    ...
    },
    {
        num: '02',
        title: 'ToDo List',
        description: '— это удобное веб-приложение, которое помогает пользователям управлять своими задачами. Приложение ориентировано на повышение продуктивности и упрощение планирования повседневных задач. С помощью этого инструмента можно легко добавлять, редактировать и удалять задачи.',
        stack: [{name: "HTML"}, {name: "Css"}, {name: "TypeScript"}, {name: "React"}, {name: "Material UI"}, {name: "RTK query"}],
